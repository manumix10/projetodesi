...
public class ModelVendas2 {
    ...
    private ArrayList<ModelVendas2> listamModelVendases;
    private int tipo;
    ...
    public ArrayList<ModelVendas2> getListamModelVendases() {
        return this.listamModelVendases;
    }

    public void setListamModelVendases(ArrayList<ModelVendas2> listamModelVendases) {
