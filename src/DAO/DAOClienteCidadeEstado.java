...
public class DAOClienteCidadeEstado
extends ConexaoFirebird {
    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public ArrayList<ModelClienteCidadeEstado> getListaClienteCidadeEstadoDAO() {
        ArrayList<ModelClienteCidadeEstado> listaModelClienteCidadeEstados;
        listaModelClienteCidadeEstados = new ArrayList<ModelClienteCidadeEstado>();
        ...
        try {
            this.conectar();
            this.executarSQL("SELECT cidade.codigo,cidade.nome,cidade.fk_cod_estado,estado.codigo,estado.uf,estado.nome,clientes.codigo, clientes.nome, clientes.endereco, clientes.bairro, clientes.cod_cidade, clientes.cod_estado, clientes.cep, clientes.telefone, clientes.cpf_cnpj, clientes.observacao  FROM cidade inner join estado on estado.codigo = cidade.fk_cod_estado  inner join clientes on cidade.codigo = clientes.cod_cidade;");
