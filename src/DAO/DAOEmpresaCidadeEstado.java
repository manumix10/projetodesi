...
extends ConexaoFirebird {
    ...
    public ModelEmpresaCidadeEstado getEmpresaCidadeEstadoDAO(int pCodigo) {
        ...
        try {
            this.conectar();
            this.executarSQL("SELECT cidade.codigo,cidade.nome,cidade.fk_cod_estado, estado.codigo, estado.uf, estado.nome, empresa.codigo,empresa.razao_social,empresa.nome_fantasia,empresa.endereco,empresa.bairro,empresa.cod_cidade,empresa.cod_estado,empresa.cep,empresa.telefone, empresa.cnpj FROM cidade inner join estado on estado.codigo = cidade.fk_cod_estado inner join empresa on cidade.codigo = empresa.cod_cidade  WHERE  empresa.codigo = '" + pCodigo + "'" + ";");
    ...
    public ArrayList<ModelEmpresaCidadeEstado> getListaEmpresaCidadeEstadoDAO() {
        ArrayList<ModelEmpresaCidadeEstado> listamodelEmpresaCidadeEstado;
        listamodelEmpresaCidadeEstado = new ArrayList<ModelEmpresaCidadeEstado>();
        ...
        try {
            this.conectar();
            this.executarSQL("SELECT cidade.codigo,cidade.nome,cidade.fk_cod_estado, estado.codigo, estado.uf, estado.nome, empresa.codigo,empresa.razao_social,empresa.nome_fantasia,empresa.endereco,empresa.bairro,empresa.cod_cidade,empresa.cod_estado,empresa.cep,empresa.telefone FROM cidade inner join estado on estado.codigo = cidade.fk_cod_estado inner join empresa on cidade.codigo = empresa.cod_cidade ;");
            while (this.getResultSet().next()) {
                modelCidade = new ModelCidade();
                modelEstado = new ModelEstado();
                modelEmpresa = new ModelEmpresa();
