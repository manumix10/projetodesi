...
public class DAOFornecedorCidadeEstado
extends ConexaoFirebird {
    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public ArrayList<ModelFornecedorCidadeEstado> getListaFornecedorCidadeEstadoDAO() {
        ArrayList<ModelFornecedorCidadeEstado> listaFornecedorCidadeEstado;
        listaFornecedorCidadeEstado = new ArrayList<ModelFornecedorCidadeEstado>();
        ...
        try {
            this.conectar();
            this.executarSQL("SELECT cidade.codigo,cidade.nome,cidade.fk_cod_estado,estado.codigo,estado.uf,estado.nome,fornecedores.codigo, fornecedores.nome, fornecedores.endereco, fornecedores.bairro, fornecedores.cod_cidade, fornecedores.cod_estado, fornecedores.cep, fornecedores.telefone  FROM cidade inner join estado on estado.codigo = cidade.fk_cod_estado  inner join fornecedores on cidade.codigo = fornecedores.cod_cidade;");
