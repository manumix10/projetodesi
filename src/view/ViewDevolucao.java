...
//    private JCheckBox jcbGerarContaPagar;
 ...
 //       this.jcbGerarContaPagar = new JCheckBox();
        ...
        this.setTitle("Devolução de Mercadorias");
        ...
        this.cbCodProdutos.addPopupMenuListener(new PopupMenuListener(){
            ...
            public void popupMenuWillBecomeInvisible(PopupMenuEvent evt) {
                ViewDevolucao.this.cbCodProdutosPopupMenuWillBecomeInvisible(evt);
            }
        ...
        this.cbCodBarrasProdutos.addPopupMenuListener(new PopupMenuListener(){
            ...
            @Override
            public void popupMenuWillBecomeInvisible(PopupMenuEvent evt) {
                ViewDevolucao.this.cbCodBarrasProdutosPopupMenuWillBecomeInvisible(evt);
            }
        ...
        this.cbNomeProduto.addPopupMenuListener(new PopupMenuListener(){
            ...
            @Override
            public void popupMenuWillBecomeInvisible(PopupMenuEvent evt) {
                ViewDevolucao.this.cbNomeProdutoPopupMenuWillBecomeInvisible(evt);
            }
        ...
        this.jtfAdicionarEstoque.addFocusListener(new FocusAdapter(){
            ...
            public void focusLost(FocusEvent evt) {
                ViewDevolucao.this.jtfAdicionarEstoqueFocusLost(evt);
            }
        });
        this.jtfAdicionarEstoque.addKeyListener(new KeyAdapter(){
            ...
            public void keyReleased(KeyEvent evt) {
                ViewDevolucao.this.jtfAdicionarEstoqueKeyReleased(evt);
            }
        });
        ...
        this.jbAdicionarProduto.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                ViewDevolucao.this.jbAdicionarProdutoActionPerformed(evt);
            }
        });
  ...
  //      this.jcbGerarContaPagar.setToolTipText("Deixe marcado para gerar uma conta a pagar");
        ...
        this.tbProdutos.setModel(new DefaultTableModel(new Object[0][], new String[]{"C\u00f3digo", "C\u00f3digo Loja", "Nome", "Qt. Anterior", "Add. Qt.", "Fornecedor", "Cod. Fornecedor", "Valor total"}){
        ...
        this.jbNovo.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ViewDevolucao.this.jbNovoActionPerformed(evt);
            }
        });
        ...
        this.btExcluir.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ViewDevolucao.this.btExcluirActionPerformed(evt);
            }
        });
        ...
        this.jbCancelar.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ViewDevolucao.this.jbCancelarActionPerformed(evt);
            }
        });
    ...
    private void cbNomeProdutoPopupMenuWillBecomeInvisible(PopupMenuEvent evt) {
        if (this.cbNomeProduto.isPopupVisible()) {
            ...
            this.jtfValorUltimaCompra.setText(this.blmascaras.arredondamentoDoubleComPontoDuasCasasString(this.modelProdutos.getValor()));
    ...
    private void jbAdicionarProdutoActionPerformed(ActionEvent evt) {
        if (this.jtfAdicionarEstoque.getText().equals("")|| this.jtfValorUltimaCompra.getText().equals("")) {
            ...
            valorUnitario = Float.parseFloat(this.jtfValorUltimaCompra.getText());
            ...
            modelo.addRow(new Object[]{this.cbCodProdutos.getSelectedItem().toString(), this.cbCodBarrasProdutos.getSelectedItem().toString(), this.cbNomeProduto.getSelectedItem().toString(), this.jtfQuantidadeEstoqueAtual.getText(), this.jtfAdicionarEstoque.getText(), this.cbFornecedores.getSelectedItem().toString(), codigoFornecedor, Float.valueOf(valorTotal)});
    ...
    private void btSalvarActionPerformed(ActionEvent evt) {
        ...
        for (int i = 0; i < this.tbProdutos.getRowCount(); ++i) {
            ...
            this.modelProdutos.setEstoque(Float.parseFloat(this.tbProdutos.getValueAt(i, 3).toString()) + (float)Integer.parseInt(this.tbProdutos.getValueAt(i, 4).toString()));// + (float)Integer.parseInt(this.tbProdutos.getValueAt(i, 5).toString()));            
            this.modelProdutos.setFornecedoresCodigo(Integer.parseInt(this.tbProdutos.getValueAt(i, 6).toString()));
         //   JOptionPane.showMessageDialog(this, "ATE AQUI TA BLZ");
            ...
            this.modelComprasProdutos.setQuantidade(Float.parseFloat(this.tbProdutos.getValueAt(i, 3).toString()) + (float)Integer.parseInt(this.tbProdutos.getValueAt(i, 4).toString()));
            this.modelComprasProdutos.setCodigoFornecedor(Integer.parseInt(this.tbProdutos.getValueAt(i, 6).toString()));
            try {
        ...
        if (!this.controllerProdutos.atualizarEstoqueProdutosController(this.modelProdutos)) {
            JOptionPane.showMessageDialog(this, "Devolução de mercadoria salva com sucesso!");
            limpaTela(rootPaneCheckingEnabled);
            this.habilitarCampos(false);
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao gravar os dados2!", "ERRO", 0);
        }
    }
    ...
    private void jButton3ActionPerformed(ActionEvent evt) {
        ...
        if (linhaSelecionada < 0) {
            ...
            Thread t = new Thread(){
                ...
                @Override
                public void run() {
                    ViewDevolucao.this.controllerComprasProdutos.gerarRelatorioCompraEstoque((Integer)ViewDevolucao.this.tbCompras.getValueAt(ViewDevolucao.this.tbCompras.getSelectedRow(), 0));
                    carregando.dispose();
                }
            };
            t.start();
    ...
    private float somaEAtualizaValorTotal() {
        ...
        for (int i = 0; i < cont; ++i) {
            valor = Float.parseFloat(String.valueOf(this.tbProdutos.getValueAt(i, 7)));
            soma = valor + soma;
        }
