...
public class ViewPdv2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jrbCodigoProduto = new javax.swing.JRadioButton();
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 0, 1630, -1));
        ...
        jrbCodigoBarras.setText("Código da Loja");

        jrbCodigoProduto.setText("Código do Produto");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jlDataHora, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jmiCancelarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiCancelarProdutoActionPerformed
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            ...
            if (linhaSelecionada < 0) {
                tbProdutos.remove(linhaSelecionada);              
            } else {
                // Remove a linha
           ...
           listaModelVendas = new ArrayList<>();
            ...
            for (int i = 0; i < tbProdutos.getRowCount(); i++) {
                ...
                try {
                    ...
                    modelVendas.setDataSaida(bl.converterDataParaDateUS(new java.util.Date(System.currentTimeMillis())));
                    modelVendas.setDataGarantia(bl.converterDataParaDateUS(new java.util.Date(System.currentTimeMillis())));
                } catch (Exception ex) {
    ...
    public void imprimirCupomTXT() throws IOException {
        ...
        gravarArq.println(" A REFRIGERAÇÃO TECNICA LTDA");
        gravarArq.println(" RUA: SANTA RITA, 1000");
        gravarArq.println(" CEP: 79100-000 - CAMPO GRANDE - MS");
    ...
    private javax.swing.JRadioButton jrbCodigoProduto;
