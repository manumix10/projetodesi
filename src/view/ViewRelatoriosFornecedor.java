 ...
 */
public class ViewRelatoriosFornecedor extends javax.swing.JFrame {
     ...
     */
    public ViewRelatoriosFornecedor() {
        initComponents();
    ...
    private void jbGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGerarRelatorioActionPerformed
        ...
        if (cbFornecedor.getSelectedItem().toString().equals("TODOS OS FORNECEDORES")) {
            if (dataInicial.equals(bl)) {
                controllerContaPagar.gerarRelatorioFornecedorTODAS(0, dataInicial, dataFinal);
            } else if (dataFinal.equals(bl)) {
                controllerContaPagar.gerarRelatorioFornecedorTODAS(1, dataInicial, dataFinal);
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewRelatoriosFornecedor().setVisible(true);
            }
        });
    }
