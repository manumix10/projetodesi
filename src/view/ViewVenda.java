...
public class ViewVenda extends javax.swing.JFrame {
    ...
    ModelOrdemServico modelOrdem = new ModelOrdemServico();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btFinalizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 580, -1, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel5.setText("Total:");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 530, -1, -1));
        ...
        tfValorTotal.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        tfValorTotal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfValorTotalActionPerformed(evt);
            }
        });
        jPanel1.add(tfValorTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 560, 140, 50));
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 840, 150));

        jPanel1.add(jcbTipoPagamento, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 500, 190, -1));
        ...
        jLabel18.setText("Observação Cliente");
        ...
        jLabel4.setText("Valor mão Obra");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(tfObservacaoCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 708, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cbCodCliente, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(148, 148, 148)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cbClientes, javax.swing.GroupLayout.PREFERRED_SIZE, 392, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(tfCpfCnpj, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(tfNumeroVenda, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, -1, -1));

        jLabel11.setText("Unid. Med.");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 280, -1, -1));

        tfUnidadeMedida.setEditable(false);
        jPanel1.add(tfUnidadeMedida, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 300, 52, -1));
        ...
        jPanel1.add(btIncluirProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 300, 60, -1));
        ...
        jPanel1.add(btRetirar, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 300, 60, -1));
        ...
        jPanel1.add(cbProdutos, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 300, 310, -1));
        ...
        jPanel1.add(cbCodProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 300, 70, -1));
        ...
        jPanel1.add(tfQuantidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 300, 50, -1));
        ...
        jPanel1.add(tfValorUnitario, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 300, 70, -1));

        jLabel20.setText("Val. Unitário");
        jPanel1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 280, -1, -1));

        tfValorTotalProduto.setEditable(false);
        jPanel1.add(tfValorTotalProduto, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 300, 70, -1));

        jLabel21.setText("Val. Total");
        jPanel1.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 280, -1, -1));
        ...
        jPanel1.add(SIM, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 520, -1, -1));
        ...
        jPanel1.add(NAO, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 520, -1, -1));

        jTabbedPane1.addTab("Cadastro Orçamento", jPanel1);
        ...
        jTabbedPane1.addTab("OS Finalizados", jPanel2);
  ...
  //      limpaTelaNovoProduto2();
    ...
    private boolean cadastrarOrcamento() {
        if (tfDesconto.getText().equals("") || tfValorTotal.getText().equals("") || tbProdutos.getRowCount() < 1) {
            ...
            for (int i = 0; i < tbProdutos.getRowCount(); i++) {
                ...
                modelOrdem = new ModelOrdemServico();
            ...
            if (codigoVenda > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Erro ao gravar os dados! ORÇAMENTO", "ERRO", JOptionPane.ERROR_MESSAGE);
                return false;
            }
        }
    }
    ...
    private boolean alterarPedido() {
        if (tfDesconto.getText().equals("") || tfValorTotal.getText().equals("") || tbProdutos.getRowCount() < 1) {
            ...
            if (controllerVendas.atualizarVendasController(modelVendas)) {
                ...
                JOptionPane.showMessageDialog(this, "Erro ao gravar os dados! PEDIDO", "ERRO", JOptionPane.ERROR_MESSAGE);
                return false;
            }
        }
    }
    ...
    private boolean aprovarAlterarPedido() {
        if (tfDesconto.getText().equals("") || tfValorTotal.getText().equals("") || tbProdutos.getRowCount() < 1) {
            ...
            listaModelVendas2 = new ArrayList<>();
            listaModelProdutos = new ArrayList<>();
            int codigoProduto;
            float quantidade;
            BLDatas bl = new BLDatas();
            ...
            for (int i = 0; i < tbProdutos.getRowCount(); i++) {
                ...
                modelProdutos = new ModelProdutos();
                modelVendas2.setCodigo(Integer.parseInt(this.tfNumeroVenda.getText()));
                modelVendas2.setClientesCodigo(controllerCliente.getClienteController(cbClientes.getSelectedItem().toString()).getCodigo());
                modelVendas2.setDesconto(Float.parseFloat(this.tfDesconto.getText()));
                modelVendas2.setValorTotal(Float.parseFloat(this.tfValorTotal.getText()));
                modelVendas2.setObservacao(this.tfObservacao.getText());
                ...
                codigoProduto = Integer.parseInt(tbProdutos.getValueAt(i, 0).toString());
                modelVendas2.setProdutosCodigo(codigoProduto);
                modelVendas2.setTipo(1);
                modelVendas2.setValor(Double.parseDouble(tbProdutos.getValueAt(i, 3).toString()));
                modelVendas2.setQuantidade(Float.parseFloat(tbProdutos.getValueAt(i, 4).toString()));
                modelVendas2.setTipoPagamento(controllerTipoPagamento.getFormaPagamentoController(this.jcbTipoPagamento.getSelectedItem().toString()).getCodigo());
                quantidade = controllerProdutos.getProdutosController(codigoProduto).getEstoque() - Float.parseFloat(tbProdutos.getValueAt(i, 4).toString());
                modelProdutos.setEstoque(quantidade);
                modelProdutos.setCodigo(codigoProduto);
            ...
            modelVendas2.setListamModelVendases(listaModelVendas2);
            modelProdutos.setListaModelProdutoses(listaModelProdutos);

            //salvar venda
            if (controllerVendas2.atualizarVendasController(modelVendas2)) {
                //excluir dados alteriores
                controllerVendas2.excluirProdutoVendasController(modelVendas2.getCodigo());
                //da baixa no estoque
                controllerProdutos.atualizarProdutosQuantidadeController(modelProdutos);
                //salvar novamente lista de produtos tualisados
                controllerVendas2.salvarVendasProdutosController(modelVendas2);
                ...
                JOptionPane.showMessageDialog(this, "Erro ao gravar os dados! ALTERA PEDIDO", "ERRO", JOptionPane.ERROR_MESSAGE);
                return false;
            }
        }
    }
    ...
    private boolean cadastrarVenda() {
        ...
        //        modelVendas.setGarantia(this.garantia);
            ...
            if (codigoVenda > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Erro ao gravar os dados! VENDA", "ERRO", JOptionPane.ERROR_MESSAGE);
                return false;
            }
        }
    }
    ...
    private void jbImprimirPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbImprimirPedidoActionPerformed
        ...
        Thread t = new Thread() {
            ...
            public void run() {
                ...
                int linha = tbConsultasPedidos.getSelectedRow();
                int codigo = (int) tbConsultasPedidos.getValueAt(linha, 0);
                controllerVendas.gerarRelatorioVenda2(codigo);
                carregando.dispose();
            }
        };
        t.start();
    ...
    private void jTextFieldPesquisar(java.awt.event.FocusEvent evt){
    ...
    private void tfDescontoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfDescontoFocusLost
        try {
            float valorMaoObra = Float.parseFloat(this.tfDesconto.getText());
 ...
 //             garantia = buttonGroup2.isSelected(pCodigo);
             if (NAO.isSelected()) {
                 NAO.setSelected(true);
                 garantia = "NAO";             
             } else if(this.SIM.isSelected()) {
             SIM.setSelected(true);
             garantia = "SIM";
             } 
      //      this.garantia.concat(modelVendas.getGarantia());
    ...
    private void carregarPedidos() {
        ...
        for (int i = 0; i < cont; i++) {
            ...
            modelo.addRow(new Object[]{
                ...
                listaModelVendas.get(i).getGarantia(),
                listaModelVendas.get(i).getDataSaida(),
                listaModelVendas.get(i).getDataGarantia()                
            });
        }
    }
